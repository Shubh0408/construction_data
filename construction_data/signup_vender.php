...
if($row>0)
{
    ...
    $msg=mysqli_query($con,"insert into vendor(fname,lname,email,companyname,gst,password,contactno) values('$fname','$lname','$email','$companyname','$gst','$password','$contact')");
...
<h2 align="center">Vendor's Registration</h2>
<hr />
...
<div class="form-floating mb-3">
<input class="form-control" id="companyname" name="companyname" type="text" placeholder="company name" required title="10 numeric characters only"   required />
<label for="inputcompanyname">Company Name</label>
</div>

<div class="form-floating mb-3">
<input class="form-control" id="gst" name="gst" type="text"  placeholder="GST no." required title="10 numeric characters only"  maxlength="12" required />
